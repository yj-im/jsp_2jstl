...
<body>
	...
	<p>jstl 을 사용하려면 먼저 taglib 설정을 해야합니다.
		<strong>prefix 속성</strong>은 태그라이브러리 사용할 때, 태그 앞에 붙는 접두어를 설정
		...
		<!-- 4. switch -->
		<h4>switch 연습</h4>
		<c:set var="age" value="75"/>  <!-- age 변수값을 변경 -->
		<!-- 회원 가입 나이 조건을 15~60세 -->
		<!-- 조건을 여러개 작성해야 할 떄 c:when 은 여러번 작성 가능 -->
		<c:choose>
